 ...
 */
function xoops_module_pre_update_xcurl(XoopsModule $module)
{
...
function xoops_module_update_xcurl(XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Xcurl\Helper $helper */
    /** @var Xcurl\Utility $utility */
    /** @var Xcurl\Configurator $configurator */
    $helper  = Xcurl\Helper::getInstance();
    $utility = new Xcurl\Utility();
    $configurator = new Xcurl\Configurator();

    if ($previousVersion < 240) {
        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'xcurlx_categories';
        $column     = 'ordre';
        $newName    = 'order';
